...
class CountyController extends Endpoint
{
    ...
    {
        $this->endpoint = $this->getDomain() . '/api/systemconfiguration/list/counties';
    }
    ...
    {
        $key = $this->institution->getConfigName() . 'counties.index';
    ...
    public function store(array $attributes): JsonResponse
    {
        ...
        return $this->response(201, $response, 'The county has been created.');
    }
    ...
    public function update(int $id, array $attributes): JsonResponse
    {
        ...
        return $this->response(200, $response, 'The county has been updated.');
    }
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        return $this->response(200, $response, 'The county has been removed.');
    }
}
